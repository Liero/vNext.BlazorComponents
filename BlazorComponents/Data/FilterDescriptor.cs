...
namespace vNext.BlazorComponents.Data
{
    ...
    public record FilterDescriptor(string Field, string Operator, object? Value) : IFilterDescriptor
    {
        /// <summary>
        ...
        public Expression<Func<TItem, bool>> CreatePredicate<TItem>() => FieldUtils.CreatePredicateLambda<TItem>(Field, Operator, Value);        
    }
}
